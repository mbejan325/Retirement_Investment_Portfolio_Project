    ...
    if age is not None:
        ...
        if int(age) < 0 or int(age) >= 65:
            return build_validation_result(
                False,
                "age",
                "Please restart, the age you entered is invalid / not supported"
                )
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "Unfortunately we cannot provide advice for any investments under $5000"
                )
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you (), based on the information
            you provided, you wanted to invest {} when you are {}
             years ; my recommendation is {}
            """.format(
                first_name, investment_amount, age, recommendation
            ),
        },
    )      
